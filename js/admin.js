...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function renderTerreiroCard(t) {
    ...
    const fotos = [];
    if (t.foto_responsavel_url) fotos.push(`<img src="${t.foto_responsavel_url}" alt="Responsável">`);
    else fotos.push('<div class="no-foto">Sem foto<br>responsável</div>');
    if (t.foto_fachada_url) fotos.push(`<img src="${t.foto_fachada_url}" alt="Fachada">`);
    else fotos.push('<div class="no-foto">Sem foto<br>fachada</div>');
    ...
    card.innerHTML = `
      ...
      <div class="fotos-row">${fotos.join('')}</div>
